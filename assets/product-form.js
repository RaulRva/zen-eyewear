if (!customElements.get('product-form')) {
  customElements.define('product-form', class ProductForm extends HTMLElement {
    ...
    onSubmitHandler(evt) {
      ...
      const cartForm = this.submitButton.getAttribute('id');
...
$('.move-cart').click(function(){
  $('cart-drawer').addClass('active animate manual-popup-btn');
   $('body').removeClass('popupoverlay');
});

$('#manual-popup .close').click(function(){
 $('.manual-popup').removeClass('manual-pop');
  $('body').removeClass('popupoverlay');
});
